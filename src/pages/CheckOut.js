...
const addresses = [
    {
        ...
        email: 'umaj@gmail.com',
        house: 'House # p-265 Street # 5 ',
        city: 'Faisalabad',
        phone: '0322-85856598',
    ...
    {
        name: 'Alexander Bell',
        email: 'udjhfd@gmail.com',

        house: 'House # p-70 Street # 10 ',
        city: 'Lahore',
        phone: '0322-8500000',
                            ...
                            <div className="border-b border-gray-900/10 pb-12">
                                ...
                                <ul role="list" >
                                    {addresses.map((address) => (
                                        <li key={address.email} className="flex gap-x-6 py-5 m-4 border-2 border-gray-400 rounded-xl  px-4">
                                            <input
                                                id="addresses"
                                                name="address"
                                                type="radio"
                                                className="h-4 w-4 border-gray-300 mt-1 text-indigo-600 focus:ring-indigo-600"
                                            />
                                            <div className="flex min-w-0 gap-x-4">

                                                <div className="min-w-0 flex-auto">
                                                    <p className="text-sm font-semibold leading-6 text-gray-900">{address.name}</p>
                                                    <p className="mt-1 truncate text-xs leading-5 text-gray-500">{address.house}</p>
